    ...
    <div className="min-md:px-20 items-center flex flex-col ">
      <div className="flex flex-col gap-6 px-6 md:max-w-[50%]">
        ...
        <p className="font-semibold text-gray-500 text-xl opacity-80">
          ...
          neque odit eius quis quidem est! Adipisci magni eligendi sunt,
          consequatur quia repellendus dolores, sequi illo dolor enim
          praesentium alias atque.
        </p>
      </div>
      <div className="flex flex-col border-2 rounded-xl mx-6 mt-30 p-4 items-center gap-6 border-purple-800 md:max-w-[50%]">
        ...
        <div className="flex flex-col items-center gap-4 ">
          ...
          <p className="text-gray-500 font-medium">
            ...
            minima labore rem eum vero similique, culpa corporis itaque modi
            assumenda voluptatem, vel neque iure ex quae iste quo enim
            reiciendis.
          </p>
        </div>
        <div className="flex flex-col gap-4 w-full">
          <button className="bg-purple-900 text-white w-full h-10 rounded-lg">
            start
          </button>
