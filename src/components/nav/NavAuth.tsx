...
export default function NavAuth() {
  ...
  return (
    <div className="flex flex-col justify-between items-center">
      <div className="flex flex-row justify-between md:justify-center w-full mt-4 items-center px-10 md:px-20 relative pb-10">
        ...
        <div className="flex flex-row gap-6 items-center md:hidden">
          <IoMdMenu
            ...
            className={show?`hidden`:`text-5xl text-purple-800` }
          />
          <IoMdClose onClick={() => setShow(!show)} className={show? `text-5xl text-purple-800`:`hidden` }/>

        </div>
        <ul className="flex flex-row justify-center gap-6 text-2xl max-md:hidden">
          <li>Home</li>
